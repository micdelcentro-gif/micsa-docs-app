              ...
              <div className="w-full max-w-sm">
                ...
                {/* Logo */}
                      <div className="text-center mb-8">
                                ...
                                <p className="text-blue-200 text-sm">Sistema de Documentos</p>p>
                      </div>div>
              
                {/* Form */}
                      <div className="bg-white rounded-2xl shadow-2xl p-6">
                                <h1 className="text-xl font-bold text-slate-800 mb-6 text-center">Iniciar Sesión</h1>h1>
                      ...
                      <div className="bg-red-50 border border-red-200 text-red-700 rounded-lg p-3 mb-4 text-sm">
                        {error}
                                ...
                                <form onSubmit={handleLogin} className="space-y-4">
                                            <div>
                                                          <label className="block text-sm font-medium text-slate-700 mb-1">Usuario</label>label>
                                                          <input
                                                                            type="text"
                                                                            value={email}
                                            ...
                                            <div>
                                                          <label className="block text-sm font-medium text-slate-700 mb-1">Contraseña</label>label>
                                                          <input
                                                                            type="password"
                                                                            value={password}
